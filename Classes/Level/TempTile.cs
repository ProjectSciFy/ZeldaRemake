...
namespace CSE3902_Game_Sprint0.Classes.Level
{
    class TempTile
    {
        ...
        public TempTile(ZeldaGame game, Vector2 position)
        {
            ...
            drawLocation = new Vector2((float) (position.X*16 + 16), (float) (position.Y*16 + 16));

    
            tile = new UniversalSprite(game, itemSpriteSheet, new Rectangle(1001, 11, 16, 16), Color.White, SpriteEffects.None, new Vector2(1, 1), 10);
