...
{
    public class XP : IItem, ICollisionEntity
    {
        ...
        public XP(ZeldaGame game, ItemSpriteFactory itemFactory, Vector2 location)
        {
            this.game = game;
            this.spriteScalar = game.util.spriteScalar;
            this.position = location;
            this.itemFactory = itemFactory;
            this.itemSprite = itemFactory.XP();
        ...
        public void Update()
        {
            ...
            hitbox.Height = (int)(8 * spriteScalar);
